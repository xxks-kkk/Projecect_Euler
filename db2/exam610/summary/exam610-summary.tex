...
\begin{center}
	...
	\textbf{SERVER} & \tabitem Authentication occurs on the server \\ \hline
	\textbf{SERVER\_ENCRYPT} & \\ \hline
	\textbf{CLIENT}  \\ \hline
	\textbf{KERBEROS}  \\ \hline
	\textbf{KRB\_SERVER\_ENCRYPT}  \\ \hline
	\textbf{DATA\_ENCRYPT}  \\ \hline
	\textbf{DATA\_ENCRYPT\_CMP} \\ \hline
	\textbf{GSSPLUGIN} \\ \hline
	\textbf{GSS\_SERVER\_ENCRYPT} \\ \hline
