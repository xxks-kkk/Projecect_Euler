...
\question[1]
A user named USER1 has been granted DATAACCESS authority for a database named PAYROLL. What is user USER1 allowed to do?
\begin{choices}
	...
	\choice Create database objects, issue database-specific DB2 commands, and run DB2 utilities that do not change data.
\end{choices}
